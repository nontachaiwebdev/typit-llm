...
const SYSTEM_PROMPT = `Du är en expert på ledningssystem för omsorgsverksamhet (personlig assistans).
...
async function rewriteQuery(
  ...
  const rewritePrompt = ChatPromptTemplate.fromMessages([
    [
      "system",
      `Du är en sökassistent för dokument om ledningssystem inom omsorgsverksamhet.
